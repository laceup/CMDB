...
--
-- Name: uniprot_id; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.uniprot_id (
    uniprot_id text NOT NULL,
    entry_name text,
    gene_name text
);
...
ALTER TABLE public.uniprot_id OWNER TO postgres;
...
--
-- Name: uniprot_id uniprot_id_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.uniprot_id
    ADD CONSTRAINT uniprot_id_pkey PRIMARY KEY (uniprot_id);
